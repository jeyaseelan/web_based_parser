...
var Validate = {
  ...
  PasswordStrength: function(value, paramsObj){
  var RegularExpression_three  =/(^(?=^.{6,40}$)(?=.*\d)(?=.*([a-z]))(?=.*([A-Z])))|(^(?=^.{6,40}$)(?=.*\d)(?=.*([a-z]))(?=.*([!@<#>$.%,^}{&[\];\"\':?\/\|\\`~*()_=+-]))([\x20-\x7E]))|(^(?=^.{6,40}$)(?=.*([a-z]))(?=.*([A-Z]))(?=.*([!@<#>$.%,^}{&[\];\"\':?\/\|\\`~*()_=+-]))([\x20-\x7E]))|(^(?=^.{6,40}$)(?=.*\d)(?=.*([A-Z]))(?=.*([!@<#>$.%,^}{&[\];\"\':?\/\|\\`~*()_=+-]))([\x20-\x7E]))/;
  
  var  RegularExpression_two  =/(^(?=^.{8,40}$)(?=.*\d)(?=.*([a-z])))|(^(?=^.{8,40}$)(?=.*\d)(?=.*([!@<#>$.%,^}{&[\];\"\':?\/\|\\`~*()_=+-]))([\x20-\x7E]))|(^(?=^.{8,40}$)(?=.*([a-z]))(?=.*([!@<#>$.%,^}{&[\];\"\':?\/\|\\`~*()_=+-]))([\x20-\x7E]))|(^(?=^.{8,40}$)(?=.*([A-Z]))(?=.*([!@<#>$.%,^}{&[\];\"\':?\/\|\\`~*()_=+-]))([\x20-\x7E]))|(^(?=^.{8,40}$)(?=.*\d)(?=.*([A-Z])))|(^(?=^.{8,40}$)(?=.*([a-z]))(?=.*([A-Z])))/;
  ...
  var params = Object.extend({
    ...
    if (value.search(RegularExpression_two)==-1) 
    {
    ...
    {
    if (value.search(RegularExpression_three)==-1) 
    {
 ...
 //regular expression defining a 5 digit number
  ...
  NameValidation: function(value, paramsObj){
   ...
   if(a==b)
    ...
    if(true) Validate.fail(params.failureMessage);
    return true;
